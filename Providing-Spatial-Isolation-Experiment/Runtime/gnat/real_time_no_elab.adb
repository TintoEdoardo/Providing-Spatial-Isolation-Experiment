...
package body Real_Time_No_Elab with
  SPARK_Mode => Off
is
   ...
   function Mul_Div (V : LLI; M : Natural; D : Positive) return LLI is
      ...
      --  rounding. We will get the value of
      --  V * M Â± D/2 as low and high part:
      --
      --    (V * M Â± D/2)_Lo = (V_Lo * M Â± D/2) with carry zeroed
      --    (V * M Â± D/2)_Hi = (V_Hi * M)
      --  with carry from (V_Lo * M Â± D/2)
      --
      --  (carry flows only from low to high part), or mathematically speaking:
      --
      --    (V * M Â± D/2)_Lo = (V * M Â± D/2) rem 2 ** 32
      --    (V * M Â± D/2)_Hi = (V * M Â± D/2)  /  2 ** 32
      --
      --  and thus
      --
      --    V * M Â± D/2 =
      --  (V * M Â± D/2)_Hi * 2 ** 32 + (V * M Â± D/2)_Lo
      --
      ...
      --  --------
      --
      --  The final result (V * M Â± D/2) / D is computed as a high and low
      --  parts:
      --
      --    ((V * M Â± D/2) / D)_Hi = (V * M Â± D/2)_Hi / D
      --    ((V * M Â± D/2) / D)_Lo =
      --        ((V * M Â± D/2)_Lo + remainder from high part division) / D
      --
      --  (remainder flows only from high to low part, opposite to carry),
      --  or mathematically speaking:
      --
      --    ((V * M Â± D/2) / D)_Hi = ((V * M Â± D/2) / D)  /  2 ** 32
      --    ((V * M Â± D/2) / D)_Lo = ((V * M Â± D/2) / D) rem 2 ** 32
      --
      --  and thus
      --
      --    (V * M Â± D/2) / D = ((V * M Â± D/2) / D)_Hi * 2 ** 32
      --                      + ((V * M Â± D/2) / D)_Lo
      --
      --  with signs just like described for V_Hi and V_Lo.
      --
